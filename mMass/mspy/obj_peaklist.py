...
class peaklist:
    ...
    def filterisotope(self, charge, mzTolerance=0.015):
        ...
        # find isotopes and remove others
        mod_peakpicking.filterisotope(peaklist = self, charge = charge, mzTolerance = mzTolerance)
